...
def save_domains_to_file(file_path, domains):
...
if __name__=="__main__":
    ...
    if args.url:
        while True:
            ...
            for seq_nr in range(1000):
                ...
                if domain == args.url:
                    # print("\nFound it, domain nr {} at {}".format(seq_nr, d.strftime("%Y-%m-%d")))
                    break
            if domain == args.url:
                break
    ...
    save_domains_to_file(args.output_file, domains)
